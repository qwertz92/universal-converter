...
<h3>Energy units are exact; fuel content is not</h3>
...
<h3>What the tool does with this</h3>
...
<h3>Power is a rate; energy is an amount</h3>
...
<h3>Why the tool refuses kW → kWh without a duration</h3>
...
<h3>Defining "year" for time arithmetic</h3>
...
<h3>Why this is exact, not approximate</h3>
...
<h3>The definitions the tool uses</h3>
...
<h3>IT versus thermochemical BTU</h3>
...
<h3>A billing unit, not a physical constant</h3>
...
<h3>Why a therm is not the same as "a therm of gas"</h3>
...
<h3>US gallon, not imperial gallon</h3>
...
<h3>Two different dimensions</h3>
<ul>
...
<h3>The boe convention this tool uses</h3>
...
<h3>The physical barrel of crude is a separate, estimated quantity</h3>
<p>Critically, the <em>actual</em> energy content of one physical barrel of crude oil is <strong>not</strong> the same as boe. Real crude energy depends on grade and API gravity and falls in an estimated range of roughly <code>~5.6–6.3 GJ</code> — genuinely variable, and marked as an estimate with a range. The fixed <code>~6.1 GJ</code> boe convention sits inside that band but is a definition, not a measurement.</p>
...
<h3>Exact by fiat, not by nature</h3>
...
<h3>Equivalence units versus real fuel</h3>
...
<h3>Why it matters for bills</h3>
...
<h3>Problem one: composition varies</h3>
...
<h3>Problem two: volume needs reference conditions</h3>
...
<h3>How a real bill is computed — and why the tool cannot reproduce it</h3>
...
<h3>Scope matters as much as the number</h3>
...
<h3>Three properties that vary</h3>
...
<h3>Where the spread comes from</h3>
<ul>
...
<h3>What the tool gives you instead</h3>
...
<h3>Three things the answer depends on</h3>
<ul>
...
<h3>What the tool does: context required</h3>
...
<h3>No default country factors in v0.1</h3>
<p>Deliberately, v0.1 ships <strong>no</strong> authoritative country-by-year grid factors as defaults. Baking in a single national number would invite exactly the false-precision error the tool exists to avoid; per-country presets are on the roadmap for later versions. For the deeper distinction between the metrics involved here, see <a href="/learn/co2-vs-co2e">CO₂ vs CO₂e</a>.</p>`,
...
<h3>Big-C Calorie versus small-c calorie</h3>
<ul>
...
<h3>How the tool prevents the mistake</h3>
